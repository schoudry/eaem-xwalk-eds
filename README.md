...
## Environments
- Preview: https://main--eaem-xwalk-eds--schoudry.aem.page/
- Live: https://main--eaem-xwalk-eds--schoudry.aem.live/
...
1. Open the `eaem-xwalk-eds` directory in your favorite IDE and start coding :)